  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-ocean to-sunset flex flex-col items-center justify-center font-funky">
      ...
      <div className="relative w-64 h-64 lg:w-80 lg:h-80 xl:w-96 xl:h-96 mb-16">
        ...
        <p className="text-5xl text-tech text-center">Hi! I'm John Porrazzo, an aspiring web developer sailing towards <span className='text-blue-700 hover:text-red-700'> divs </span> unknown</p>
        <p className="text-4xl text-tech mt-4 text-center">Welcome to my portfolio website! <br/> I built it with React, Vite, Tailwind CSS, and <span className='text-blue-700 hover:text-red-700'>lots of love</span></p>
